...
definePageMeta({
  guest: true,
  middleware: ['auth'],
  title: 'Trang quản lý Tòa nhà',
  meta: [
    { name: 'description', content: 'Hệ thống quản lý Tòa nhà Thành phố Hà Nội' },
    { name: 'keywords', content: 'quản lý tòa nhà, hệ thống, thành phố Hà Nội' },
  ],
});
</script>
<template>
    <div className="card">
        <div class="container flex flex-col mx-auto px-4">
            ...
            <div class="flex md:flex-row gap-4 mb-6 md:justify-end">
                ...
                <div class="text-white rounded-lg shadow-md bg-primary-contrast">
                    <div class="p-6">
                    <div class="flex justify-between items-center">
                        <div>
                        <h4 class="text-2xl font-bold mb-1">{{ buildingCount }}</h4>
                        <p class="text-primary text-black text-sm">Tổng số tòa nhà</p>
                        </div>
                ...
                <div class="text-white rounded-lg shadow-md bg-primary-contrast">
                    ...
                    <div class="flex justify-between items-center">
                        ...
                        <p class="text-primary text-sm">Ngày cập nhật</p>
                        </div>
                        <div class="flex items-center">
            ...
            <!-- Add Button -->
            <div class="flex flex-col md:flex-row lg:flex-row md:justify-between  mb-6">
                <div class="lg:w-1/4 md:w-3/5 sm:w-full py-2">
                <InputGroup>
                ...
                <div class="lg:w-1/6 md:w-1/3 sm:w-full py-2">
                <Button label="Thêm tòa nhà mới" @click="openAddModal" class="w-full"/>
                </div>
            </div>
            <Dialog 
